...
## Project Structure
    ...
    ├── testapiautostoryboa_94453  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_94453`
...
2. Clone this repo and `cd testapiautostoryboa_94453`
